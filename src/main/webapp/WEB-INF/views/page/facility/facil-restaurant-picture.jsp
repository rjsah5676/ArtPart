...
<div id="fade">
<h1 id="text">Restaurant</h1>
    <div id="container">
        <div class="SliderBox" id="sliderContainer">
            <div id="slider">
            	 <img src="${pageContext.request.contextPath}/img/page/facility/Restaurant1.jpg" />
           		 <img src="${pageContext.request.contextPath}/img/page/facility/Restaurant2.jpg" />
           		 <img src="${pageContext.request.contextPath}/img/page/facility/Restaurant3.jpg"/>
                 <img src="${pageContext.request.contextPath}/img/page/facility/Restaurant4.jpg"/>
                 <img src="${pageContext.request.contextPath}/img/page/facility/Restaurant5.jpg"/>
                 <img src="${pageContext.request.contextPath}/img/page/facility/Restaurant6.jpg"/>
            </div>
            ...
            <div id="content">
            	<ul>
            		<li><div id="type1">타입</div><div>다이닝</div></li>
            		<li><div id="type1">위치</div><div>8F</div></li>
            		<li><div id="type1">이용시간</div><div>07:00~21:00</div></li>
            		<li><div id="type1">문의안내</div><div>02-2222-2222</div></li>
            	</ul>
            </div>
         </div>
	    </div>
